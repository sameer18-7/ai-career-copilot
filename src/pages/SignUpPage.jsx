    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[45%] gradient-hero relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/60 text-lg leading-relaxed max-w-sm mb-10">
            Join thousands of students who are using AI to land their dream jobs faster than ever.
          </p>
        ...
        {/* Floating stats card */}
        <div className="relative z-10">
          <div className="card-float p-5 rounded-2xl inline-block animate-float-slow" style={{ background: 'rgba(255,255,255,0.95)' }}>
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl gradient-blue flex items-center justify-center">
                <CheckCircle size={24} className="text-white" />
              </div>
              <div>
                <p className="text-2xl font-extrabold text-navy">10,000+</p>
                <p className="text-xs text-text-secondary">Students placed successfully</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <h2 className="text-2xl font-extrabold text-navy mb-1">Create your account</h2>
          <p className="text-sm text-text-secondary mb-8">
            Already have an account?{' '}
            <Link to="/login" className="text-royal-blue font-semibold hover:underline no-underline">
              Log in
            </Link>
          </p>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-xs text-text-muted font-medium">or sign up with email</span>
            <div className="flex-1 h-px bg-gray-200" />
          </div>
          ...
          <form className="space-y-4" onSubmit={e => e.preventDefault()}>
            ...
            <div>
              <label className="text-sm font-medium text-navy mb-1.5 block">Confirm Password</label>
              <div className="relative">
                <input
            ...
            <label className="flex items-start gap-2.5 cursor-pointer">
              <input type="checkbox" className="mt-1 accent-royal-blue w-4 h-4 rounded" />
              <span className="text-xs text-text-secondary leading-relaxed">
                I agree to the{' '}
                <a href="#" className="text-royal-blue font-medium hover:underline">Terms of Service</a>
                {' '}and{' '}
                <a href="#" className="text-royal-blue font-medium hover:underline">Privacy Policy</a>
              </span>
            </label>
